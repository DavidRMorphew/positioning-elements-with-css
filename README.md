...
not the intended effect, you can use the `clear` property and set it to clear, or reset from,
...
As CSS3 techniques become more widely adopted, hacks such as the clearfix may soon become
...
Observe the example below to see how elements are affected when positioning and `z-index` are applied:
...
We will discuss later how to to adjust for this limitation.
